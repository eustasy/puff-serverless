CREATE TABLE public.organisation_key_values (
    ...
    CONSTRAINT organisation_key_values_owner_org_fkey FOREIGN KEY (owner_org_uuid)
        REFERENCES public.organisations(org_uuid) ON DELETE CASCADE,
    CONSTRAINT organisation_key_values_owner_app_fkey FOREIGN KEY (owner_app_uuid) REFERENCES public.apps(app_uuid) ON DELETE CASCADE,
    CONSTRAINT organisation_key_values_one_owner CHECK (
    ...
    INDEX idx_organisation_key_values_owner_app (owner_app_uuid ASC)
