      ...
      try {
        ...
        if (ctx.confirm) {
          let confirmed = await new Promise((resolve) => {
            let detail = {
              ctx,
              issueRequest: () => resolve(true),
              dropRequest: () => resolve(false),
            }
