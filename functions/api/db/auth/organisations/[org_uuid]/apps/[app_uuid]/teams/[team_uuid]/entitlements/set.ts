...
import { parseSetForm, validateEntitlementKey } from "../../../../../../../../../../../src/utilities/entitlements-endpoint.js"
...
export const onRequestPost: Handler<"app_uuid" | "org_uuid" | "team_uuid"> = async (context) => {
  ...
  const result = await setKeyValue(context.data.dbClient!, team_uuid, { type: "app", app_uuid: app.app_uuid }, parsed.key, parsed.value)
  if (!result.success) {
